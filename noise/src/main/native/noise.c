...
Java_com_paramsen_noise_NoiseNativeBridge_realThreadSafe(JNIEnv *env, jclass jThis,
                                                         jfloatArray jInput,
                                                         jfloatArray jOutput) {
...
Java_com_paramsen_noise_NoiseNativeBridge_realOptimizedCfg(JNIEnv *env, jclass jThis,
                                                           jint inSize) {
...
JNIEXPORT void JNICALL
Java_com_paramsen_noise_NoiseNativeBridge_realOptimizedCfgDispose(JNIEnv *env, jclass jThis,
                                                                  jlong cfgPointer) {
...
JNIEXPORT void JNICALL
Java_com_paramsen_noise_NoiseNativeBridge_realOptimized(JNIEnv *env, jclass jThis,
                                                        jfloatArray jInput,
...
JNIEXPORT void JNICALL
Java_com_paramsen_noise_NoiseNativeBridge_imaginaryThreadSafe(JNIEnv *env, jclass jThis,
                                                              jfloatArray jInput,
                                                              jfloatArray jOutput) {
    jsize inSize = (*env)->GetArrayLength(env, jInput);
    jsize outSize = (*env)->GetArrayLength(env, jOutput);
...
JNIEXPORT jlong JNICALL
Java_com_paramsen_noise_NoiseNativeBridge_imaginaryOptimizedCfg(JNIEnv *env, jclass jThis,
                                                                jint inSize) {
...
JNIEXPORT void JNICALL
Java_com_paramsen_noise_NoiseNativeBridge_imaginaryOptimizedCfgDispose(JNIEnv *env, jclass jThis,
                                                                       jlong cfgPointer) {
...
JNIEXPORT void JNICALL
Java_com_paramsen_noise_NoiseNativeBridge_imaginaryOptimized(JNIEnv *env, jclass jThis,
                                                             jfloatArray jInput,
                                                             jfloatArray jOutput,
                                                             jlong cfgPointer) {
    jsize inSize = (*env)->GetArrayLength(env, jInput);
